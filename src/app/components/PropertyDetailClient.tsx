...
export default function PropertyDetailClient({ property: p }: { property: PropertyDetail }) {
  ...
  return (
    ...
    >
      {/* Header / Navigation */}
      <motion.div variants={itemVariants} className="bg-white border-b sticky top-0 z-10 shadow-sm">
            ...
            <motion.div variants={itemVariants} className="lg:col-span-2 space-y-8">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <motion.div whileHover={{ scale: 1.05 }} className="flex flex-col items-center p-4 bg-gray-50 rounded-xl">
